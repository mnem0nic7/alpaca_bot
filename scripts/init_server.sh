...
SECOND_STRATEGY_SCAN_TIMEOUT_SECONDS=7200
SECOND_STRATEGY_OUTPUT_ROOT=/var/lib/alpaca-bot/nightly/second_strategy
SECOND_STRATEGY_EXCLUDE_CANDIDATES=ema_pullback,vwap_cross
...
PROOF_STATUS_SECOND_STRATEGY_MAX_AGE_HOURS=48
PROOF_STATUS_SECOND_STRATEGY_MIN_PROOF_HORIZON_PASS_RATE=0.50
PROMOTE_VALIDATED_STRATEGY_MAX_EVIDENCE_AGE_HOURS=48
PROMOTE_VALIDATED_STRATEGY_MIN_PROOF_HORIZON_PASS_RATE=0.50
