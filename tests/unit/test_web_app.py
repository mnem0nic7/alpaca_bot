...
def test_dashboard_route_renders_runtime_snapshot() -> None:
    ...
    proof_check = SimpleNamespace(
        ...
        payload={
            ...
            "proof_nightly_age_minutes": "none",
            ...
            "proof_current_execution_capacity_rejected": "0",
            "proof_current_execution_short_window": "0",
    ...
    assert 'class="value mono warn">\n              observing' not in response.text
    ...
    assert (
        "current_exec=observing warnings=none"
        in response.text
    )
    assert (
    ...
    assert "run_age=none" in response.text
    ...
    assert "nightly_run_age=none" in response.text
